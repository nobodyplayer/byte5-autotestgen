...
"""
sta = state.TestCaseGenerationState(prd_content=text, detected_testPoint=[], generated_cases=[], total_evaluation_report={}, single_evaluation_report=[], vectorstore=None)
